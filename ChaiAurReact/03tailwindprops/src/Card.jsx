...
function Card({username,btnText}) {
  ...
  return (
    ...
    <div className="ml-4 mb-4 flex-none w-52 relative">
      <img src="https://tailwindcss.com/_next/static/media/fancy-suit-jacket.edfeb695.jpg" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
    </div>
