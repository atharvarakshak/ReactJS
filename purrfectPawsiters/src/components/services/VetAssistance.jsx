  ...
  return (
    <div className=' flex flex-col md:flex-row items-center justify-center   relative top-20 px-4 md:px-0 py-10'>
      <div className='md:w-1/3 md:mr-6 relative bottom-20  md:right-60'>
        <img src={Section} alt="" className='hidden md:block md:absolute md:bottom-28 md:right-28 w-full h-full z-[-1]' />
        <img src={m4} alt='Pet' className='relative  top-20 md:left-20 h-full w-full md:h-auto  -mt-20 md:-mt-0 ' />
      </div>
